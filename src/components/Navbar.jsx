...
import {Navbar, NavbarBrand, NavbarContent, NavbarItem, Link ,NavbarMenuItem,NavbarMenuToggle,NavbarMenu ,DropdownItem ,Dropdown ,DropdownTrigger ,DropdownMenu ,Avatar ,
    ...
    <Navbar onMenuOpenChange={setIsMenuOpen}>
      <NavbarContent>
        ...
        <NavbarBrand >
          ...
          <p className="font-bold text-inherit md:text-center cursor-pointer" ><span className="text-red-400 hover:text-blue-500">E-Com</span><span className="text-blue-500 hover:text-red-400">merce</span></p>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarItem className="cursor-pointer">       <Badge color="danger" content={cart}  shape="circle">
        ...
        <NavbarItem >
          ...
          <NavbarItem>
            {status.userStatus ? (
              ...
              <RLink className="bg-blue-500 text-tiny px-4 py-2 text-white rounded-lg" to="/login">
                Login
              </RLink>
            )}
          </NavbarItem>
...
:
      ...
      <NavbarMenu>
        {navItems.map((item, index) => (
          <NavbarMenuItem key={`${item}-${index}`} className=" capitalize cursor-pointer">
            <Link
